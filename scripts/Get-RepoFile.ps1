<#
.SYNOPSIS
    Reads one file of the repository (schema, component, config).
.EXAMPLE
    ./scripts/Get-RepoFile.ps1 -Path src/sanity/schemaTypes/documents/page.ts
#>
[CmdletBinding()]
param(
...
(Get-Api "/api/plugins/sanity/repo/file/$(Esc $Path)").content
