<#
.SYNOPSIS
    Makes a configured project the active one for shells that do not name a project.
.EXAMPLE
    ./scripts/Switch-Project.ps1 -Name "My site"
#>
[CmdletBinding()]
param(
...
Post-Api '/api/plugins/sanity/projects/active' @{ name = $Name } | ConvertTo-Json
