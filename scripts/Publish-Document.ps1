<#
.SYNOPSIS
    Publishes a document: copies its draft over the published version and drops the draft.
.EXAMPLE
    ./scripts/Publish-Document.ps1 -Type press -Id press-article-1
#>
[CmdletBinding()]
param(
...
Post-Api "/api/plugins/sanity/documents/$(Esc $Type)/$(Esc $Id)/publish" @{} | ConvertTo-Json
