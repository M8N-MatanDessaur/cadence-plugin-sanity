<#
.SYNOPSIS
    One type as plain text: its fields (from the repository schema, or inferred) and every document with a data preview.
.EXAMPLE
    ./scripts/Get-TypeSummary.ps1 -Type press
#>
[CmdletBinding()]
param(
...
Get-Text "/api/plugins/sanity/summary/$(Esc $Type)"
