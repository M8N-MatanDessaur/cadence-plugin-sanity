<#
.SYNOPSIS
    Audit one type: missing titles, stale documents, drafts, images without alt text.
.EXAMPLE
    ./scripts/Audit-Content.ps1 -Type press
#>
[CmdletBinding()]
param(
...
Get-Api "/api/plugins/sanity/audit/$(Esc $Type)" | ConvertTo-Json -Depth 6
