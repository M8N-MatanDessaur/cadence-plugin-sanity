<#
.SYNOPSIS
    Sets which environment (site URL) previews use for the active project.
.EXAMPLE
    ./scripts/Switch-Environment.ps1 -Env local
#>
[CmdletBinding()]
param(
...
Post-Api '/api/plugins/sanity/env' @{ env = $Env } | ConvertTo-Json
