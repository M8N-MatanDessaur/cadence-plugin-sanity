<#
.SYNOPSIS
    Takes a document off the site: the published version becomes a draft.
.EXAMPLE
    ./scripts/Unpublish-Document.ps1 -Type press -Id press-article-1
#>
[CmdletBinding()]
param(
...
Post-Api "/api/plugins/sanity/documents/$(Esc $Type)/$(Esc $Id)/unpublish" @{} | ConvertTo-Json
